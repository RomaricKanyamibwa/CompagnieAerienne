...
<title>Calev Devise Paie - Ajouter un salarié</title>
              ...
              <f:hidden path="id"/>
                <div class="form-group row">
                  ...
                  <label><fmt:message key="common.prenom" /></label>
                    <f:input type="text" path="prenom" class="form-control form-control-user" placeholder="Prénom"/>
                  </div>
                </div>
                <div class="form-group">
                <label><fmt:message key="common.numsecu" /></label>
                  <f:input type="text" path="numsecu" class="form-control form-control-user" placeholder="Numero sécu"/>
                </div>              
                  
                </div>
                <div class="panel-footer">
                <button type="submit" class="btn btn-primary"><i class="fa fa-save">&nbsp;<fmt:message key="common.enregistrer" /></i></button>
                <a href="<c:url value="/salarie/"/>" class="btn btn-danger"><i class="fa fa-arrow-left">&nbsp;<fmt:message key="common.annuler" /></i></a>
                </div>
                <hr>
