...
<tfoot>
	...
	<th rowspan="1" colspan="1"><fmt:message
			...
			<!-- Appel du notification pop up -->
			 <c:url value="/salarie/supprimer/${salarie.getId() }" var="urlSupprim"></c:url>	
			<a href="${urlSupprim }" data-toggle="modal" data-target="#modalSalarie${salarie.getId() }"><i class="fa fa-trash-alt"></i></a>	 	
			<%--<a href="javascript:void(0);" data-toggle="modal" data-target="#modalSalarie${salarie.getId() }"><i class="fa fa-trash-alt"></i></a> --%>
            <div class="modal fade" id="modalSalarie${salarie.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-footer">
			...
			<c:url value="/salarie/supprimer/${salarie.getId() }" var="urlSuppression" />
...
<!-- Custom scripts for all pages-->
 ...
 $('#modalSalarie').on('shown.bs.modal', function () {
